public class Date implements Comparable<Date> {
	...
	public Date clone() {
		Date newDate = new Date(this.getMonth(), this.getDay(), this.getYear());
		return newDate;
	}
	...
	public int compareTo(Date that) { // improvement would to return the number of days between, like String returns
